...
public interface CategoryRepository extends JpaRepository<CategoryModel, Long> {
    ...
    @Query("SELECT cm FROM RecipeModel rm JOIN rm.categories cm WHERE rm = :recipe")
    List<CategoryModel> findCategoryModelsByRecipe(@Param("recipe") RecipeModel recipe);
}
